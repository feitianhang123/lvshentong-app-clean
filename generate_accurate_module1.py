...
<body>
    ...
    # 组合完整的HTML文件
    js_array = '\n'.join(js_array_lines)
    full_html = html_template.replace('{js_array}', js_array)
    
    # 保存文件
    output_path = 'android-project/app/src/main/assets/www/module1_fixed_final_v23.html'
    with open(output_path, 'w', encoding='utf-8') as f:
        f.write(full_html)
    
    print(f'已生成准确模块一v23文件: {output_path}')
...
if __name__ == "__main__":
    output_file = generate_accurate_module1()
    ...
    if output_file:
        ...
        # 替换模块一链接
        index_content = index_content.replace('module1_fixed_final_v22.html', 'module1_fixed_final_v23.html')
