...
def fix_module1_direct():
    ...
    # 检查数组行数
    array_start = new_content.find('const fullExcelData = [')
    array_end = new_content.find('];', array_start)
    array_content = new_content[array_start:array_end+2]
...
if __name__ == "__main__":
    output_file = fix_module1_direct()
