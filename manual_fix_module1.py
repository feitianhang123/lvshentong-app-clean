...
def manual_fix_module1():
    ...
    array_end = content.find('];', array_start) + 2
    
    print(f'Array start: {array_start}')
    print(f'Array end: {array_end}')
    
    # 替换数组内容
    new_content = content[:array_start] + js_array + content[array_end:]
    ...
    # 保存新文件
    output_path = 'android-project/app/src/main/assets/www/module1_fixed_final_v11.html'
    with open(output_path, 'w', encoding='utf-8') as f:
        f.write(new_content)
    
    print(f'已生成模块一v11文件: {output_path}')
...
if __name__ == "__main__":
    output_file = manual_fix_module1()
    ...
    if output_file:
        ...
        # 替换模块一链接
        index_content = index_content.replace('module1_fixed_final_v6.html', 'module1_fixed_final_v11.html')
