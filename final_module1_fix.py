...
def create_final_module1():
    ...
    # 保存新文件
    output_path = 'android-project/app/src/main/assets/www/module1_fixed_final_v15.html'
    with open(output_path, 'w', encoding='utf-8') as f:
        f.write(new_content)
    
    print(f'已生成模块一v15文件: {output_path}')
...
if __name__ == "__main__":
    output_file = create_final_module1()
    ...
    if output_file:
        ...
        # 替换模块一链接
        index_content = index_content.replace('module1_fixed_final_v14.html', 'module1_fixed_final_v15.html')
