...
def create_correct_module1():
    ...
    # 读取模板文件
    template_path = 'android-project/app/src/main/assets/www/module1_fixed_final_v6.html'
    ...
    print(f'Original array length: {array_end - array_start}')
    print(f'New array length: {len(js_array)}')
    ...
    # 保存新文件
    output_path = 'android-project/app/src/main/assets/www/module1_fixed_final_v16.html'
    with open(output_path, 'w', encoding='utf-8') as f:
        f.write(new_content)
    
    print(f'已生成模块一v16文件: {output_path}')
...
if __name__ == "__main__":
    ...
    if output_file:
        ...
        # 替换模块一链接
        index_content = index_content.replace('module1_fixed_final_v15.html', 'module1_fixed_final_v16.html')
